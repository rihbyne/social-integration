...
/*===========================================================================================================================*/
    ...
    app.get('/getpost/:username', post.getuserposts); 							// Get post by username
    app.get('/getpost/:username/count', post.getuserpostcount);                 // Get post count by username
    app.get('/getpost/:username/:post_id', post.getuserpost); 					// Get single post of user
    ...
    app.post('/deleteRetweet', retweet.deleteRetweet); 						// delete retweet                                                                                                                                                                                                                                // delete Retweet
